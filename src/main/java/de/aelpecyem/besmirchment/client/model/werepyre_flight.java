...
public class werepyre_flight extends EntityModel<Entity> {
...
public werepyre_flight() {
		...
		setRotationAngle(lWing01, -0.2618F, 1.0036F, -0.2618F);
		...
		setRotationAngle(lWing02, 1.0036F, 0.0F, 0.0F);
		...
		setRotationAngle(lWing03, 0.9687F, 0.0F, 0.0F);
		...
		setRotationAngle(lWing04, -0.2182F, 0.0F, 0.0F);
		...
		setRotationAngle(lWingMembrane02, -0.7505F, 0.0F, 0.0F);
		...
		setRotationAngle(rWing01, -0.2618F, -1.0036F, 0.2618F);
		...
		setRotationAngle(rWing02, 1.0036F, 0.0F, 0.0F);
		...
		setRotationAngle(rWing03, 0.9687F, 0.0F, 0.0F);
		...
		setRotationAngle(rWing04, -0.2182F, 0.0F, 0.0F);
		...
		setRotationAngle(rWingMembrane02, -0.7505F, 0.0F, 0.0F);
